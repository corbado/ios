...
3. Tag and push:
   ...
   `SHA256SUMS`, `RELEASE.txt` (version, commit and toolchain), `LICENSE`, and
   `LIMITATIONS.md` to the GitHub release. The archive includes the privacy manifest
   and test fixtures; `.gitattributes` excludes examples and internal tooling.
